      ...
      <div className="h-[85vh] relative">
        ...
        <div className="container  tracking-tighter h-full flex flex-col items-start justify-end py-16 relative z-10 text-dimondra-white">
          ...
          <p className=" talentPara max-w-3xl mt-2 text-slate-100">
            At Dimondra, we help you find, attract, and hire top talent that
            fits your business needs and company culture. Our Talent Acquisition
            ...
            Whether you&nbsp;re hiring for a few key roles or scaling up
            rapidly, we offer support that saves you time and ensures quality
            hires.
          </p>
          <button

...
const PopForm = ({
  ...
  return (
    <AnimatePresence>
      {isOpen ? (
        <div className=" z-[999] fixed inset-0 w-screen h-screen flex justify-center items-center bg-slate-900/70 ">
          <div className="container w-full !p-0 grid grid-cols-1 lg:grid-cols-2 rounded-xl relative">
            <button
            ...
            <img
              ...
              className="w-full hidden lg:blockF h-full object-cover"
            />
